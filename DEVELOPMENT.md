...
```bash
git remote add encore encore://hello-world-application-eqqi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/hello-world-application-eqqi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/hello-world-application-eqqi/settings/integrations/github)
