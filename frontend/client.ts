 ...
 */
import { hello as api_hello_hello_hello } from "~backend/hello/hello";
...
export namespace hello {
    ...
    export class ServiceClient {
         ...
         */
        public async hello(): Promise<ResponseType<typeof api_hello_hello_hello>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/hello`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_hello_hello_hello>
        }
    }
}
